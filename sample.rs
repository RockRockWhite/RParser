...
impl RParser {
    ...
    pub fn new() -> Self {
        ...
        // ======================
        let action_table: ActionTable =  serde_json::from_str(r#"{"states":[{"actions":{"A":{"Shift":1},"b":{"Reduce":{"left":"A","right":[]}},"__$__":"Accept","a":{"Shift":5},"S":{"Shift":9}}},{"actions":{"a":{"Reduce":{"left":"B","right":[]}},"__$__":{"Reduce":{"left":"B","right":[]}},"B":{"Shift":8},"b":{"Shift":2}}},{"actions":{"a":{"Shift":5},"b":{"Reduce":{"left":"A","right":[]}},"__$__":{"Reduce":{"left":"A","right":[]}},"A":{"Shift":3}}},{"actions":{"b":{"Shift":4}}},{"actions":{"__$__":{"Reduce":{"left":"B","right":["b","A","b"]}},"a":{"Reduce":{"left":"B","right":["b","A","b"]}}}},{"actions":{"a":{"Reduce":{"left":"B","right":[]}},"b":{"Shift":2},"B":{"Shift":6},"__$__":{"Reduce":{"left":"B","right":[]}}}},{"actions":{"a":{"Shift":7}}},{"actions":{"__$__":{"Reduce":{"left":"A","right":["a","B","a"]}},"b":{"Reduce":{"left":"A","right":["a","B","a"]}}}},{"actions":{"__$__":{"Reduce":{"left":"S","right":["A","B"]}}}},{"actions":{"__$__":{"Reduce":{"left":"__DUMMY_START__","right":["S"]}}}}]}"#).unwrap();
        // ======================
        ...
        // ======================
        handlers.insert(
            ReduceDerivation::build("S".into(), vec!["A".into(), "B".into()]),
            Box::new(|datas| {
        "".clone()
    }),
        );handlers.insert(
            ReduceDerivation::build("A".into(), vec!["a".into(), "B".into(), "a".into()]),
            Box::new(|datas|{
        println!("reduce: A -> aBa")
        datas[0].clone()
    }),
        );handlers.insert(
            ReduceDerivation::build("A".into(), vec!["__EPSILON__".into()]),
            Box::new(|datas|{
        println!("reduce: A -> __EPSILON__")
        datas[0].clone()
    }),
        );handlers.insert(
            ReduceDerivation::build("B".into(), vec!["b".into(), "A".into(), "b".into()]),
            Box::new(|datas|{
        println!("reduce: B -> bAb")
        datas[0].clone()
    }),
        );handlers.insert(
            ReduceDerivation::build("B".into(), vec!["__EPSILON__".into()]),
            Box::new(|datas|{
        println!("reduce: B -> __EPSILON__")
        datas[0].clone()
    }),
        );
        // ======================
